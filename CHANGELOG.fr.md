...
- **Cause** : `default=` forçait toujours les valeurs, `suggested_value` n'incluait pas les champs effacés dans la soumission
- **Fix** : `default=` conditionnel - défini uniquement si une valeur existe, sinon pas de default. Les champs effacés sont correctement détectés et supprimés
